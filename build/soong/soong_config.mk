...
_json_contents := $(_json_contents)    "MoKee":{$(newline)
...
$(call add_json_bool, Uses_qti_camera2client, $(filter true,$(TARGET_USES_QTI_CAMERA2CLIENT)))
$(call add_json_bool, Uses_generic_camera2client, $(if $(filter true,$(TARGET_USES_QTI_CAMERA2CLIENT)),,true))
